...
// import { IonContent, IonCard, IonItem, IonLabel, IonText, IonButton,IonSelectOption } from "@ionic/angular/standalone";

// @Component({
//   selector: 'app-oirs-form',
//   standalone: true,
//   imports: [IonButton, IonText, IonLabel, IonItem, IonCard, IonContent,IonSelectOption,
//     CommonModule,
//     FormsModule,
//     ReactiveFormsModule,
//     RouterModule
...
//       tipoSolicitud: this.formBuilder.control('', [Validators.required]),
//       region: this.formBuilder.control('', [Validators.required]),
//       comuna: this.formBuilder.control('', [Validators.required]),
//       esAfectado: this.formBuilder.control(false, [Validators.required]),
//       detalles: this.formBuilder.control('', [Validators.required, Validators.minLength(10)]),
//     });
...
@Component({
  ...
  standalone: true,
  imports: [
    IonButton, IonText, IonLabel, IonItem, IonCard, IonContent, IonSelectOption,
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    RouterModule,
...
export class OirsFormPage {
  ...
  private _oirsService = inject(OirsService);
  ...
  oirsForm = this._formBuilder.group({
    tipoSolicitud: this._formBuilder.control('', [Validators.required]),
    region: this._formBuilder.control('', [Validators.required]),
    comuna: this._formBuilder.control('', [Validators.required]),
    esAfectado: this._formBuilder.control(false, [Validators.required]),
    detalles: this._formBuilder.control('', [Validators.required, Validators.minLength(10)]),
  });
